...
ActiveRecord::Schema[8.0].define(version: 2025_08_06_025046) do
  ...
  create_table "visits", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["biodatum_id"], name: "index_visits_on_biodatum_id"
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "biodata_fields", "biodata", on_delete: :cascade
  add_foreign_key "biodata_fields", "biodata_sections", on_delete: :cascade
  add_foreign_key "biodata_sections", "biodata"
  add_foreign_key "visits", "biodata"
end
