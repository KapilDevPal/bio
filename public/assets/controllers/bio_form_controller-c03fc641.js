  ...
  addField(event) {
    ...
    const fieldHtml = `
      <div class="field-container flex items-center space-x-4 p-4 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200" data-field-id="new-${fieldIndex}">
        ...
        <button type="button" data-action="click->bio-form#removeField" class="text-red-600 hover:text-red-800 p-2 rounded-lg hover:bg-red-50 transition-colors">
      ...
      <div class="section-container bg-gradient-to-r from-gray-50 to-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200" data-section-id="new-${sectionIndex}">
        <div class="flex items-center justify-between mb-6">
          ...
          <div class="flex items-center space-x-3">
            <button type="button" data-action="click->bio-form#addField" class="text-emerald-600 hover:text-emerald-800 p-2 rounded-lg hover:bg-emerald-50 transition-colors">
              <i class="fas fa-plus text-lg"></i>
            </button>
            <button type="button" data-action="click->bio-form#removeSection" class="text-red-600 hover:text-red-800 p-2 rounded-lg hover:bg-red-50 transition-colors">
